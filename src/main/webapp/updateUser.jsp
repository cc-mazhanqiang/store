...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="row">
            <form action="/store/updateUserServlet" method="post">
                <%--隐藏域提交username--%>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>出生日期：</th>
                        <td>${user.birthday}</td>
                        <td><input type="date" name="birthday" class="form-control" placeholder="年-月-日"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="telephone" class="form-control" placeholder="请输入您的新手机号"
                                   maxlength="11"></td>
                    ...
                    <tr>
                        ...
                        <th>用户邮箱：</th>
                        <td>${user.email}</td>
                        <td><input type="text" name="email" class="form-control" placeholder="请输入新邮箱信息"></td>

                    </tr>
                </table>
                <div style="margin-left: 850px">
                    <button class="btn btn-success">修改个人信息</button>
                </div>
            </form>
        </div>
    </div>
