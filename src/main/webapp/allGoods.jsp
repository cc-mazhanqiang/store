...
<head>
    ...
    <script>
        ...
        function load(currentPage) {
            $.get("/store/findAllGoodsServlet",{currentPage:currentPage},function (pageBean) {
                //显示查询的结果
                var lis = '';

                for (var i = 0; i < pageBean.list.length; i++) {
                    //获取{id:1,name:   ...}
                    var good = pageBean.list[i];

                    var tr = '<tr>\n' +
                        '                    <td>'+good.id+'</td>\n' +
                        '                    <td>'+good.name+'</td>\n' +
                        '                    <td>'+good.price+'</td>\n' +
                        '                    <td><img src="data:image/jpeg;base64,'+good.pic+'" width="100px" height="100px"/></td>\n' +
                        '                    <td>'+good.cid+'</td>\n' +
                        '                    <td>\n' +
...
<div class="container">
    ...
    <ul class="nav nav-pills nav-justified" style="margin-top: 50px;">
        ...
        <li><a href="allUsers.jsp">查询用户信息</a></li>
        </ul>
        </li>
        <li role="presentation" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
    ...
    <div class="col-md-12" style="margin-top: 60px;">
        ...
        <table class="table table-hover" style="text-align: center;">
            <thead>
            <tr>
                <th style="text-align: center;">设备识别码</th>
